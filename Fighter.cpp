...
void Fighter::initVariables(float& _hp, float& _damage, bool is_enemy)
{
	this->hp = _hp;
	this->damage = _damage;
...
Fighter::Fighter(float _x, float _y, sf::Texture& texture_sheet, std::string _name, float _hp, float _damage, bool is_enemy)
{
	this->initVariables(_hp, _damage, is_enemy);
